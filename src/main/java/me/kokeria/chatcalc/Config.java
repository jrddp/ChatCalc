...
import me.kokeria.chatcalc.event.EventHandler;
...
@Mod.EventBusSubscriber(modid = ChatCalc.MODID, bus = Mod.EventBusSubscriber.Bus.MOD)
public final class Config {
    ...
    public final static class ClientConfig {
        ...
        public final ForgeConfigSpec.ConfigValue<String> DECIMAL_FORMAT;
    ...
    static void bakeConfig() {
        EventHandler.changeDecimalFormat(Config.CLIENT.DECIMAL_FORMAT.get());
    }
